...
import { FETCH_FILM_FULL, FETCH_FILMS } from '../../redux/types';
...
test('Initial State reducer WorkerMovies', () => expectSaga(sagaWorkerAllMovies)
...
test('Initial State reducer WorkerMovies', () => expectSaga(sagaWorkerFullMovie)
