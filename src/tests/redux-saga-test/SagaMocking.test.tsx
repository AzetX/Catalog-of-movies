...
test('fetching FullMovie', () => {
    const fakeFullmovie = {Title:"Bill",Year:"2015", Rated:"PG", Released:"18 Sep 2015", Runtime:"94 min", Genre:"Comedy, Family, History", Director:"Richard Bracewell", Writer:"Laurence Rickard, Ben Willbond", Actors:"Mathew Baynton, Simon Farnaby, Martha Howe-Douglas, Jim Howick"}
